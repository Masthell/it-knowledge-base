...
1. [Практика](1-practice/) актуально настройка серверов, задачи
2. [Скрипты](2-scripts/) автоматизация рутины
3. [Проблемы](3-problems/) ошибки и как я их решила
4. [Шпаргалки](4-cheatsheets/) команды, конфиги, cheat sheets

## Let's start with the fundamentals: laboratory and basic services

#### Начнём с фундамента: лабораторные и базовые сервисы

- [Сетевые технологии](https://github.com/Masthell/it-knowledge-base/blob/main/1-practice/network_technologies.md)
- [Инструменты администрирования и мониторинг 1с](https://github.com/Masthell/it-knowledge-base/blob/main/1-practice/administratio%D1%82_and_monitoring_tools_1c.md)
- [Архитектура кластера 1С](https://github.com/Masthell/it-knowledge-base/blob/main/1-practice/1c_enterprise_cluster.md)
